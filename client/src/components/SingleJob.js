    ...
    return (
        <>
            <Box fullWidth sx={{ background: 'linear-gradient(to right, #8e2de2, #4a00e0)', boxShadow: '10px 20px 10px #ccc', color: 'white', textAlign: 'center', padding: '10px 20px' }}>
                ...
                <Button variant='contained' LinkComponent={Link} onClick={handleApply} sx={{ margin: '1', padding: '10px 20px', backgroundImage: 'radial-gradient(100% 100% at 100% 0, #5adaff 0, #5468ff 100%)', color: 'white' }} endIcon={<WorkIcon />}>Apply Now</Button>
            </Box>
